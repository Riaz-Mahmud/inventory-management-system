    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        ...
	        <div class="form-group">
	        	<label for="productName" class="col-sm-3 control-label">Product Name:<mark>*</mark></label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
					...
					<div class="form-group">
	        	<label for="partNumber" class="col-sm-3 control-label">Parts Number: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="partNumber" placeholder="Part Number" name="partNumber" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->

	        <div class="form-group">
	        	<label for="quantity" class="col-sm-3 control-label">Quantity:<mark>*</mark></label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				    ...
				    <div class="col-sm-8">
				      <select class="form-control" id="brandName" name="brandName">
				      	...
				      	?>
							...
							<label style="margin-top:5px;">Add New Brand</label>
							<input type="text" class="form-control" id="newBrandName" name="newBrandName" placeholder="Brand Name"  autocomplete="off" style="margin-top:-2px;">
							<button type="button" id="addNewBrandBtn" name="addNewBrandBtn" class="btn btn-primary" autocomplete="off" style="margin-top:3px;"> ADD</button>
							<label id="errorNewBrand"></label>
				    </div>
	        </div> <!-- /form-group-->
				    ...
				    <div class="col-sm-8">
				      <select type="text" class="form-control" id="categoryName" placeholder="Product Name" name="categoryName" >
				      	...
				      	?>
							...
							<label style="margin-top:5px;">Add New Category</label>
							<input type="text" class="form-control" id="newCategoryName" name="newCategoryName" placeholder="Category Name"  autocomplete="off" style="margin-top:-2px;">
							<button type="button" id="addNewCategoryBtn" name="addNewCategoryBtn" class="btn btn-primary" autocomplete="off" style="margin-top:3px;"> ADD</button>
							<label id="errorNewCategory"></label>
				    </div>
	        </div> <!-- /form-group-->
	      	...
	      	<div class="div-result">
				  ...
				  <div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane" id="productInfo">
				    	...
				    	<div class="form-group">
			        	<label for="editProductName" class="col-sm-3 control-label">Product Name:<mark>*</mark></label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
							...
							<div class="form-group">
			        	<label for="editPartsNumber" class="col-sm-3 control-label">Parts Number: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editPartsNumber" placeholder="Product Name" name="editPartsNumber" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->

			        <div class="form-group">
			        	<label for="editQuantity" class="col-sm-3 control-label">Quantity:<mark>*</mark></label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
