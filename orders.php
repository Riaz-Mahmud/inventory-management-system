...
<?php
$dueTotal = 0;
$sql ="SELECT SUM(due) AS dueTotal FROM orders WHERE order_status = 1";
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="col-md-6">
			  	<div class="form-group">
				   ...
				   <!--/form-group-->
					 <div class="form-group">
 				    <label for="vat" class="col-sm-3 control-label gst">VAT 0%</label>
 				    <div class="col-sm-9">
						...
						<table class="table" id="priceTable" style="margin-top:25px;">
							...
							<tbody>
								<tr>
									...
									<th style=" text-align: right;"><?php echo $dueTotal ." BDT"; ?></th>
								</tr>
						</tbody>
						</table>
			</div>
			  ...
			  <div class="col-md-6">
			  	<div class="form-group">
					...
					<div class="form-group">
				 	<label for="vat" class="col-sm-3 control-label gst">VAT 0%</label>
				 	<div class="col-sm-9">
				 		<input type="text" class="form-control" id="vat" name="gstn" readonly="false" value="0" />
				 		<input type="hidden" class="form-control" id="vatValue" name="vatValue" />
				 	</div>
				 </div>
				  <div class="form-group">
				      ...
				      <select class="form-control" name="paymentStatus" id="paymentStatus">
				      	...
				      	<option value="1" <?php if($data[12] == 1) {
				      		echo "selected";
								...
								<option value="4" <?php if($data[12] == 4) {
				      		echo "selected";
