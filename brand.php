	      ...
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
					...
					<div class="form-group">
					 <label for="brandDes" class="col-sm-3 control-label">Description: </label>
					 <label class="col-sm-1 control-label">: </label>
					 <div class="col-sm-8">
						 <input type="text" class="form-control" id="brandDes" placeholder="Brand Description" name="brandDes" autocomplete="off">
					 </div>
				 </div> <!-- /form-group-->
	        <div class="form-group">
		      ...
		      <div class="edit-brand-result">
		      	<div class="form-group">
		        	...
		        	<label class="col-sm-1 control-label">: </label>
						...
						<div class="form-group">
		        	<label for="editBrandDes" class="col-sm-3 control-label">Description: </label>
		        	<label class="col-sm-1 control-label">: </label>
					    <div class="col-sm-8">
					      <input type="text" class="form-control" id="editBrandDes" placeholder="Brand Description" name="editBrandDes" autocomplete="off">
					    </div>
		        </div> <!-- /form-group-->
		        <div class="form-group">
