	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        ...
	        <div class="form-group">
	        	<label for="upassword" class="col-sm-3 control-label">Password: </label>
					...
					<div class="form-group">
	        	<label for="uType" class="col-sm-3 control-label">User Type: </label>

				    <div class="col-sm-8">
							<select type="text" class="form-control" id="uType" name="uType" autocomplete="off">
				        ...
				        <div class="form-group">
				        	<label for="editPassword" class="col-sm-3 control-label">Password: </label>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select type="text" class="form-control" id="editUserType" name="editUserType" autocomplete="off">
											<option value="">~~SELECT~~</option>
											<option value="1">Admin</option>
											<option value="2">User</option>
										</select>
