...
if($_POST) {
  ...
  $gstn 				= $_POST['gstn'];
	...
	$sqlActivity = "INSERT INTO activity (name,details,itemName) VALUES ('$addedBy','Edit Order','$orderId')";
